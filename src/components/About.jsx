          ...
          <div className="col-md-6 align-items-center d-flex" style={{padding:'0 calc(2.5rem)'}}>
            <div >
              ...
              <p className="mt-4 fs-5 opacity-75">
               Be the part of a sharing college community which<br/>helps each other through various pre-owened things
              </p>
            </div>
          </div>
      ...
      <div className="container">
        <div className="row py-4">
          ...
          <div className="col-md-6 order-first order-md-last align-items-center d-flex justify-content-end" style={{padding:'0 calc(2.5rem)'}}>
            <div >
            <h3>A decentralised store<br/> for everyone</h3>
            <p className="mt-4 fs-5 opacity-75" >
            Find your requirement from comfort of your<br/> home without spending any money .<br/>
            </p>
            </div>
          </div>
        </div>
